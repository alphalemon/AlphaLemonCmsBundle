...
/**
 *  Implements the BlockRepositoryInterface to work with Doctrine
 *
 *  @author alphalemon <webmaster@alphalemon.com>
 */
class AlBlockRepositoryDoctrine extends Base\AlDoctrineRepository implements BlockRepositoryInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    public function setRepositoryObject($object = null)
    {
        if (null !== $object && !$object instanceof AlBlock) {
            throw new InvalidParameterTypeException('AlBlockRepositoryDoctrine accepts only AlBlock Doctrine objects');
        }
