...
/**
 *  Implements the LanguageRepositoryInterface to work with Doctrine
 *
 *  @author alphalemon <webmaster@alphalemon.com>
 */
class AlLanguageRepositoryDoctrine extends Base\AlDoctrineRepository implements LanguageRepositoryInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    public function setRepositoryObject($object = null)
    {
        if (null !== $object && !$object instanceof AlLanguage) {
            throw new InvalidParameterTypeException('AlLanguageRepositoryDoctrine accepts only AlLanguage Doctrine objects');
        }
